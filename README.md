...
Drafting 은 **AGPLv3 + 추가 조건**(상표·귀속)으로 배포되는 자유 소프트웨어입니다.
쓰고, 돌리고, 고칠 수 있습니다. 수정본을 네트워크 서비스로 돌린다면 소스를 공개해야 하고,
포크를 "Drafting" 이름으로 배포할 수 없습니다.

2026-09-02 이전 릴리스는 MIT 이며 그대로 유지됩니다. [LICENSE.md](LICENSE.md) 를 보세요.
